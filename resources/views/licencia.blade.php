    ...
    <body><div class="container" style="padding: 30px;">
        <div class="container" style="border-top: 1px solid black;border-left: 1px solid black;border-bottom: 1px solid black;border-right: 1px solid black;border-radius: 10px;">
           ...
           <div class="col-md-9">
            <div class="col-md-12">
                ...
                <div >
                   ...
                   <div class="col-md-7">
                       <br><br>
                       <label for="">ERNESTO ISMAEL RAMIREZ MORA</label>
                       <br> <br>
                       ...
                       R.F.C: <label for="">BACR510505</label><br>
                       Sexo: <label for="">M</label><br>
           ...
           <div class="col-md-3" align="center">
            <br><br>
               <img src="images/infantil.jpg" style="width: 140px; height: 160px;"><br>
               No. de Licencia
               <br>
